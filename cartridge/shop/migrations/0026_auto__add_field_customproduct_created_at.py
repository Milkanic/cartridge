...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomProduct.created_at'
        db.add_column(u'shop_customproduct', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 30, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomProduct.created_at'
        db.delete_column(u'shop_customproduct', 'created_at')
    ...
    models = {
        ...
        u'quotes.quote': {
            ...
            '_meta_title': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['quotes.Author']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expiry_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'gen_description': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'quote_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'short_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
        ...
        u'shop.customproduct': {
            'Meta': {'ordering': "('-id',)", 'object_name': 'CustomProduct'},
            ...
            'quote': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['quotes.Quote']", 'null': 'True', 'blank': 'True'}),
        ...
        u'shop.product': {
            ...
            'content': ('mezzanine.core.fields.RichTextField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'custom_product': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
