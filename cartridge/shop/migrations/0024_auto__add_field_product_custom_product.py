...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.custom_product'
        db.add_column(u'shop_product', 'custom_product',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.custom_product'
        db.delete_column(u'shop_product', 'custom_product')
